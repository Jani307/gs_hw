...
class Animal:
    ...
    def make_sound(self):
        if self.age > 10:
            print(f'Old {self.species} {self.name} sounds small.')
        else:
            print(f'Young {self.species} {self.name} sounds loud.')


dog = Animal('Spark', 'dog', 12)
cat = Animal('Wiskas', 'cat', 3)
...
rec_1 = Rectangle(2, 4)
rec_2 = Rectangle(120, 65)

print(rec_1.calculate_area(), rec_2.calculate_area(), sep='\n')
